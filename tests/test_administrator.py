...
from constants import (EDIT_GOODS_HEADER_TEXT, NEW_GOOD_NAME,
                       NEW_GOOD_DESCRIPTION, NEW_GOOD_CATEGORY,
                       NEW_GOOD_PRICE, NEW_GOOD_IMAGE_URL,
                       EDITED_GOOD_NAME, EDITED_GOOD_DESCRIPTION,
                       EDITED_GOOD_CATEGORY, EDITED_GOOD_PRICE,
...
class TestAdministrator:
    ...
    def test_make_edit_delete_good(self, subtests, driver,
        ...
        with allure.step("Проверка создания товаров"):
            ...
            with allure.step("Сохранение фактических значений созданного товара"):
        ...
        with allure.step("Проверка редактирования товара"):
            ...
            with allure.step("Сохранение фактических значений обновленного товара"):
                actual_name_edidded_good = edit.get_name().lower()
                actual_description_edidded_good = edit.get_description().lower()
                actual_category_edidded_good = edit.get_category().lower()
                actual_price_edidded_good = edit.get_price().lower()
