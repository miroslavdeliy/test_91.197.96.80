...
class CartPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.empty_cart_message = (
            By.XPATH, "//*[@id='app']/div/div/div[1]/div/div[1]/div"
        )
        self.product_1_name = (
            By.XPATH,
            "//*[@id='app']/div/div/div[1]/div/div[1]/div[2]/div[3]/"
            "div[1]/div"
        )
        self.product_1_input = (
            By.XPATH,
            "//*[@id='app']/div/div/div[1]/div/div[1]/div[2]/div[3]/div[2]/"
            "div[1]/input"
        )
        ...
        self.total = (
            By.XPATH, "//*[@id='app']/div/div/div[1]/div/div[2]/div[1]"
        )
        self.make_order_button = (
            By.XPATH,
            "//*[@id='app']/div/div/div[1]/div/div[2]/div[2]/a/button"
        )
    ...
    def is_make_order_button_visible(self):
        return self._get_element(
            self.make_order_button, condition="present"
        ).is_displayed()
