...
class ShopPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.product_1_name = (
            By.XPATH, "//*[@id='app']/div/div/div[1]/div/div[1]/div[3]/div"
        )
        self.product_1_description = (
            By.XPATH, "//*[@id='app']/div/div/div[1]/div/div[1]/div[3]/p"
        )
        self.product_1_price = (
            By.XPATH, "//*[@id='app']/div/div/div[1]/div/div[1]/div[6]"
        )
        self.product_1_image = (
            By.XPATH, "//*[@id='app']/div/div/div[1]/div/div[1]/div[1]/img"
        )
        self.product_1_input = (
            By.XPATH,
            "//*[@id='app']/div/div/div[1]/div/div[1]/div[4]/div/input"
        )
        self.product_1_button_plus = (
            By.XPATH,
            "//*[@id='app']/div/div/div[1]/div/div[1]/div[4]/div/button[2]/"
            "span"
        )
        self.product_1_button_minus = (
            By.XPATH,
            "//*[@id='app']/div/div/div[1]/div/div[1]/div[4]/div/button[1]/"
            "span"
        )
        self.quantity_goods_in_cart = (
            By.XPATH, "//*[@id='app']/div/nav/div/a[2]/button/span[2]"
        )
        self.cart_icon = (
            By.XPATH, "//*[@id='app']/div/nav/div/a[2]/button/span[1]"
        )
    ...
    def add_product_1(self):
        ...
        self._wait_until(
            lambda d: int(
                d.find_element(*self.product_1_input).get_attribute("value")
            ) == value_before + 1
        )
